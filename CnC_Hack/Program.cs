...
namespace CnC_Hack
{
    class Program
    {
        ...
        static readonly int entryBaseAddressZH = 0x8E0338;
        static readonly int entryBaseAddress = 0x8425B8;
        ...
        static Process process = null;  //search value
        ...
        private static void InitHack()
        {
            try
            {
                while (process == null)
                {
                    ...
                    {
                        Console.Write("Looking for Generals.exe");
                        consoleoutput.Add("Looking for Generals.exe");
                    }
                    Console.Write(".");
                    consoleoutput.Add(".");
